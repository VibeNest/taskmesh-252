  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button variant="outline" className="h-10" onClick={() => signIn('google', { callbackUrl: '/workspaces' })}>
        ...
        <Button variant="outline" className="h-10" onClick={() => signIn('github', { callbackUrl: '/workspaces' })}>
